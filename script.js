...
async function dangXuat() {
  const confirm = await showConfirm('Đăng xuất', 'Bạn có chắc muốn rời khỏi hệ thống?', 'danger');
  if (confirm) {
...
function updateHeaderUI() {
  ...
  const objectEl = document.getElementById('header-object'); // Thêm ID Object
