...
// ==================== CẤU HÌNH HỆ THỐNG ====================
const API_URL = "https://script.google.com/macros/s/AKfycbxnT_V_odD0UydI6MwXjojVprE_cEpAMvHoTr79NpCD8WdcU-kI9gdvI6YgCy4GLlFe/exec";
...
// =========================================================================
  ...
  <header class="main-header sticky top-0 z-[1000] w-full relative bg-white/85 backdrop-blur-md border-b border-[#00b5e2]/10 shadow-[0_4px_20px_rgba(0,76,109,0.03)]">
    <div class="mx-auto px-4 md:px-6 flex items-center justify-between w-[90%] h-[72px] relative">  
