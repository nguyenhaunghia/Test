  ...
  col2.innerHTML = `
    ...
    <ul class="space-y-2">
      ...
      <li>
        ...
        <div class="submenu-container space-y-2">
           <div class="menu-item submenu-item flex items-center cursor-pointer" onclick="${actionGB}"><i class="fas fa-list-check mr-3 text-blue-200 text-sm"></i><span class="text-sm">Giao nhiệm vụ</span></div>
